...
def task_1_add_new_record_to_db(con) -> None:   # use context manager
    """
...
def task_2_list_all_customers(cur) -> list:      # context manager is already created
    """
...
def task_16_match_all_customers_and_suppliers_by_country(cur):
    ...
    Returns: 194 records
    """
    cur.execute("""SELECT Customers.CustomerName, Customers.Address, 
                   Customers.Country AS "customercountry", 
                   Suppliers.Country AS "suppliercountry", 
                   Suppliers.SupplierName 
                   FROM Customers FULL JOIN Suppliers 
